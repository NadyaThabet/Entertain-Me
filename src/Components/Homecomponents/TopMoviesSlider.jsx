...
const TopMoviesSlider = () => {
  ...
  return (
    <div className="mt-5 mb-5 container">
      <h1 className="text-warning mt-5 fw-bold">Best Movies</h1>
      <div className="row  grid gap-4 justify-content-center mt-4">
        {topmovies.map((movie, index) => (
          <Card style={{ width: "18rem" }} key={index} className="col-3 card">
            <Card.Img
              className="mt-3"
              variant="top"
            ...
            <Card.Body>
              ...
              <ShowMoreText
                ...
                more="Show more"
                less="Show less"
                className="text-decoration-none text-light mb-3"
                width={280}
