...
const SearchResults = () => {
  ...
  return (
    <div className="min-vh-100 container">
      <h1 className="text-warning fw-bold w-100 text-center mb-4 mt-5">
        Search-Results
      </h1>
      ...
      searchResult.results.length === 0 ? (
        <h1 className="text-center text-light mt-5"></h1>
      ) : (
              ...
              (result) =>
                result.poster_path && (
                  <div key={result.id} className="m-3">
                    <Card style={{ width: "18rem" }} className="card card-div">
                      <Card.Img
                        variant="top"
                        width="20%"
